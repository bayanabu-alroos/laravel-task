    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-danger mt-5" href="{{ route('movies.index') }}"> 
  ...
  <path d="M5.232 4.293a.5.5 0 0 0-.7-.106L.54 7.127a1.147 1.147 0 0 0 0 1.946l3.994 2.94a.5.5 0 1 0 .593-.805L1.114 8.254a.503.503 0 0 0-.042-.028.147.147 0 0 1 0-.252.5.5 0 0 0 .042-.028l4.012-2.954a.5.5 0 0 0 .106-.699z"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 mb-3 mt-3">
            <div class="form-group">
                <strong>Image:</strong>
                <img src="/images/{{ $movie->image }}" width="500px">
            </div>
        </div>
...
<!-- 
    <div class="card text-dark mt-5 mb-4" style="width: 30rem;">
  <img src="/images/{{ $movie->image }}" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title"><strong>Movie Name:</strong> {{ $movie->name }}</h5>
    <p class="card-text"><strong>Movie Gener:</strong>{{ $movie->gener }}</p>
    <p class="card-text"><strong>Movie Description:</strong> {{ $movie->description }}</p>
  </div>
</div> -->



<div class="card mb-5 mt-5 text-dark" style="max-width: 900px;">
  <div class="row g-0">
    <div class="col-md-5">
      <img src="/images/{{ $movie->image }}" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-7">
      <div class="card-body">
        <h5 class="card-title"><strong>Movie Name:</strong> {{ $movie->name }}</h5><br>
        <p class="card-text"><strong>Movie Gener:</strong> {{ $movie->gener }}</p>
        <p class="card-text"><strong>Movie Description:</strong> {{ $movie->description }}</p>
      </div>
    </div>
