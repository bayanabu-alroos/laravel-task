    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right mb-4 mt-4">
                <a class="btn btn-danger" href="{{ route('movies.index') }}">
         ...
         <div class="row">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10">
                <div class="form-group">
                    ...
                    <input type="text" name="gener"  value="{{ $movie->gener }}" class="form-control" placeholder="Movie Gener">
                </div>
            </div>
            <div class="col-xs-10 col-sm-10 col-md-10">
                <div class="form-group">
                    <strong>Movie Description:</strong>
                    <textarea class="form-control" style="height:150px" name="description" placeholder="Movie Description">{{ $movie->description }}</textarea>
                </div>
            </div>
            <div class="col-xs-10 col-sm-10 col-md-10">
                <div class="form-group">
                    ...
                    <br>
                    <img src="/images/{{ $movie->image }}" width="300px">
                </div>
            </div>
