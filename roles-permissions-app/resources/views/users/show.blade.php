...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right mt-5 mb-5">
            <a class="btn btn-danger" href="{{ route('users.index') }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-reply-all" viewBox="0 0 16 16">
        ...
        <div class="form-group">
            ...
            @if(!empty($user->getRoleNames()))
                @foreach($user->getRoleNames() as $v)
                    <p class="badge rounded-pill bg-dark">{{ $v }}</p>
                @endforeach
            @endif
        </div>
    </div>
