...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right mt-5 mb-5">
            <a class="btn btn-danger" href="{{ route('roles.index') }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-reply-all" viewBox="0 0 16 16">
