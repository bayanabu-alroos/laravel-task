...
<center><h2 class="text-light mt-5 mb-5 px-auto" >Edit Movie</h2></center>

    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
            
                <a class="btn btn-danger" href="{{ route('admin.index') }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-reply-all" viewBox="0 0 16 16">
         ...
         <div class="row">
            ...
            <div style class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="file" name="movie_img" class="form-control" placeholder="movie_img" value="{{asset('movie_img/'.$movie->movie_img)}}">
                        </div>
                    </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="movie_description" placeholder="movie_description">{{ $movie->movie_description }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text"class="form-control" name="movie_gener" placeholder="Gener" value="{{ $movie->movie_gener }}">
            </div>
        </div> 
